...
// The Application Insights Instrumentation Key can also
// be configured with the APPINSIGHTS_INSTRUMENTATIONKEY env var
var appInsightsKey = '';
...
if(appInsightsKey.length > 0) {
  ...
  appInsightsClient = appInsights.getClient(appInsightsKey);
}
